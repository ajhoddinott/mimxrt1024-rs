#[doc = "Register `PFD_480_SET` reader"]
pub struct R(crate::R<PFD_480_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PFD_480_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PFD_480_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PFD_480_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PFD_480_SET` writer"]
pub struct W(crate::W<PFD_480_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PFD_480_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PFD_480_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PFD_480_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PFD0_FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PFD_480_SET_SPEC, u8, u8, 6, O>;
...
pub type PFD0_CLKGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFD_480_SET_SPEC, bool, O>;
...
pub type PFD1_FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PFD_480_SET_SPEC, u8, u8, 6, O>;
...
pub type PFD1_CLKGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFD_480_SET_SPEC, bool, O>;
...
pub type PFD2_FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PFD_480_SET_SPEC, u8, u8, 6, O>;
...
pub type PFD2_CLKGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFD_480_SET_SPEC, bool, O>;
...
pub type PFD3_FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PFD_480_SET_SPEC, u8, u8, 6, O>;
...
pub type PFD3_CLKGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PFD_480_SET_SPEC, bool, O>;
impl R {
...
#[doc = "480MHz Clock (PLL3) Phase Fractional Divider Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pfd_480_set](index.html) module"]
pub struct PFD_480_SET_SPEC;
impl crate::RegisterSpec for PFD_480_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pfd_480_set::R](R) reader structure"]
impl crate::Readable for PFD_480_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pfd_480_set::W](W) writer structure"]
impl crate::Writable for PFD_480_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PFD_480_SET to value 0x1311_100c"]
impl crate::Resettable for PFD_480_SET_SPEC {
