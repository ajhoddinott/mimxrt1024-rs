...
pub struct R(crate::R<PLL_SYS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_SYS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_SYS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_SYS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_SYS` writer"]
pub struct W(crate::W<PLL_SYS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_SYS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_SYS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_SYS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_SELECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_SYS_SPEC, bool, O>;
...
pub type POWERDOWN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_SYS_SPEC, bool, O>;
#[doc = "Field `ENABLE` reader - Enable PLL output"]
pub type ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `ENABLE` writer - Enable PLL output"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_SYS_SPEC, bool, O>;
...
pub type BYPASS_CLK_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_SYS_SPEC, u8, BYPASS_CLK_SRC_A, 2, O>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_SYS_SPEC, bool, O>;
...
#[doc = "`reset()` method sets PLL_SYS to value 0x0001_3001"]
