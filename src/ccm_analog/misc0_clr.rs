...
#[doc = "Field `REFTOP_VBGADJ` reader - Not related to CCM. See Power Management Unit (PMU)"]
...
#[doc = "Field `REFTOP_VBGADJ` writer - Not related to CCM. See Power Management Unit (PMU)"]
