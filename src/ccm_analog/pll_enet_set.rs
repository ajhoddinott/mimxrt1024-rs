#[doc = "Register `PLL_ENET_SET` reader"]
pub struct R(crate::R<PLL_ENET_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_ENET_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_ENET_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_ENET_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_ENET_SET` writer"]
pub struct W(crate::W<PLL_ENET_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_ENET_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_ENET_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_ENET_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_SELECT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_ENET_SET_SPEC, u8, u8, 2, O>;
...
pub type POWERDOWN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_ENET_SET_SPEC, bool, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_ENET_SET_SPEC, bool, O>;
...
pub type BYPASS_CLK_SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_ENET_SET_SPEC, u8, BYPASS_CLK_SRC_A, 2, O>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_ENET_SET_SPEC, bool, O>;
...
pub type ENET_25M_REF_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_ENET_SET_SPEC, bool, O>;
...
pub type ENET_500M_REF_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_ENET_SET_SPEC, bool, O>;
...
#[doc = "Analog ENET PLL Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_enet_set](index.html) module"]
pub struct PLL_ENET_SET_SPEC;
impl crate::RegisterSpec for PLL_ENET_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_enet_set::R](R) reader structure"]
impl crate::Readable for PLL_ENET_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_enet_set::W](W) writer structure"]
impl crate::Writable for PLL_ENET_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PLL_ENET_SET to value 0x0001_1001"]
impl crate::Resettable for PLL_ENET_SET_SPEC {
