#[doc = "Register `LOWPWR_CTRL` reader"]
pub struct R(crate::R<LOWPWR_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LOWPWR_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LOWPWR_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LOWPWR_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LOWPWR_CTRL` writer"]
pub struct W(crate::W<LOWPWR_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LOWPWR_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LOWPWR_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LOWPWR_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RC_OSC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, RC_OSC_EN_A, O>;
...
pub type OSC_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, OSC_SEL_A, O>;
...
pub type LPBG_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, LPBG_SEL_A, O>;
...
pub type LPBG_TEST_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type REFTOP_IBIAS_OFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type L1_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type L2_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type CPU_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type DISPLAY_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type RCOSC_CG_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type XTALOSC_PWRUP_DELAY_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, LOWPWR_CTRL_SPEC, u8, XTALOSC_PWRUP_DELAY_A, 2, O>;
...
pub type MIX_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
...
pub type GPU_PWRGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOWPWR_CTRL_SPEC, bool, O>;
impl R {
...
#[doc = "XTAL OSC (LP) Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lowpwr_ctrl](index.html) module"]
pub struct LOWPWR_CTRL_SPEC;
impl crate::RegisterSpec for LOWPWR_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lowpwr_ctrl::R](R) reader structure"]
impl crate::Readable for LOWPWR_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lowpwr_ctrl::W](W) writer structure"]
impl crate::Writable for LOWPWR_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LOWPWR_CTRL to value 0x4001"]
impl crate::Resettable for LOWPWR_CTRL_SPEC {
