#[doc = "Register `OSC_CONFIG2` reader"]
pub struct R(crate::R<OSC_CONFIG2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OSC_CONFIG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OSC_CONFIG2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OSC_CONFIG2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OSC_CONFIG2` writer"]
pub struct W(crate::W<OSC_CONFIG2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OSC_CONFIG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OSC_CONFIG2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OSC_CONFIG2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COUNT_1M_TRG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OSC_CONFIG2_SPEC, u16, u16, 12, O>;
...
pub type ENABLE_1M_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSC_CONFIG2_SPEC, bool, O>;
...
pub type MUX_1M_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSC_CONFIG2_SPEC, bool, O>;
...
pub type CLK_1M_ERR_FL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OSC_CONFIG2_SPEC, bool, O>;
impl R {
...
#[doc = "XTAL OSC Configuration 2 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [osc_config2](index.html) module"]
pub struct OSC_CONFIG2_SPEC;
impl crate::RegisterSpec for OSC_CONFIG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [osc_config2::R](R) reader structure"]
impl crate::Readable for OSC_CONFIG2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [osc_config2::W](W) writer structure"]
impl crate::Writable for OSC_CONFIG2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OSC_CONFIG2 to value 0x0001_02e2"]
impl crate::Resettable for OSC_CONFIG2_SPEC {
