...
pub struct R(crate::R<TCR5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCR5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCR5` writer"]
pub struct W(crate::W<TCR5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCR5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FBT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR5_SPEC, u8, u8, 5, O>;
#[doc = "Field `W0W` reader - Word 0 Width"]
pub type W0W_R = crate::FieldReader<u8, u8>;
#[doc = "Field `W0W` writer - Word 0 Width"]
pub type W0W_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR5_SPEC, u8, u8, 5, O>;
#[doc = "Field `WNW` reader - Word N Width"]
pub type WNW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WNW` writer - Word N Width"]
pub type WNW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR5_SPEC, u8, u8, 5, O>;
impl R {
