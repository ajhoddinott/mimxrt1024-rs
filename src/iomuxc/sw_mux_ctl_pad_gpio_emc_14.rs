#[doc = "Register `SW_MUX_CTL_PAD_GPIO_EMC_14` reader"]
pub struct R(crate::R<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_MUX_CTL_PAD_GPIO_EMC_14` writer"]
pub struct W(crate::W<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum MUX_MODE_A {
    ...
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: FLEXCAN1_TX of instance: flexcan1"]
    ALT6_FLEXCAN1_TX = 6,
}
...
impl MUX_MODE_R {
    ...
    pub fn variant(&self) -> Option<MUX_MODE_A> {
        match self.bits {
            ...
            6 => Some(MUX_MODE_A::ALT6_FLEXCAN1_TX),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `ALT6_FLEXCAN1_TX`"]
    #[inline(always)]
    pub fn is_alt6_flexcan1_tx(&self) -> bool {
        *self == MUX_MODE_A::ALT6_FLEXCAN1_TX
    }
}
#[doc = "Field `MUX_MODE` writer - MUX Mode Select Field."]
pub type MUX_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC, u8, MUX_MODE_A, 3, O>;
impl<'a, const O: u8> MUX_MODE_W<'a, O> {
    ...
    #[inline(always)]
    pub fn alt6_flexcan1_tx(self) -> &'a mut W {
        self.variant(MUX_MODE_A::ALT6_FLEXCAN1_TX)
    }
}
...
pub type SION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC, SION_A, O>;
...
#[doc = "SW_MUX_CTL_PAD_GPIO_EMC_14 SW MUX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_mux_ctl_pad_gpio_emc_14](index.html) module"]
pub struct SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC;
impl crate::RegisterSpec for SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_mux_ctl_pad_gpio_emc_14::R](R) reader structure"]
impl crate::Readable for SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_mux_ctl_pad_gpio_emc_14::W](W) writer structure"]
impl crate::Writable for SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_MUX_CTL_PAD_GPIO_EMC_14 to value 0x05"]
impl crate::Resettable for SW_MUX_CTL_PAD_GPIO_EMC_14_SPEC {
