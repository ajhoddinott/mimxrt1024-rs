#[doc = "Register `SW_MUX_CTL_PAD_GPIO_SD_B1_05` reader"]
pub struct R(crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_MUX_CTL_PAD_GPIO_SD_B1_05` writer"]
pub struct W(crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum MUX_MODE_A {
    ...
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPI_A_DQS of instance: flexspi_bus2bit"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_RDATA01 of instance: enet"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI3_MCLK of instance: sai3"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: FLEXSPI_B_SS0_B of instance: flexspi_bus2bit"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO3_IO25 of instance: gpio3"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: CCM_PMIC_RDY of instance: ccm"]
    ALT6 = 6,
}
...
pub type MUX_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC, u8, MUX_MODE_A, 3, O>;
...
pub type SION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC, SION_A, O>;
...
#[doc = "SW_MUX_CTL_PAD_GPIO_SD_B1_05 SW MUX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_mux_ctl_pad_gpio_sd_b1_05](index.html) module"]
pub struct SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC;
impl crate::RegisterSpec for SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_mux_ctl_pad_gpio_sd_b1_05::R](R) reader structure"]
impl crate::Readable for SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_mux_ctl_pad_gpio_sd_b1_05::W](W) writer structure"]
impl crate::Writable for SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_MUX_CTL_PAD_GPIO_SD_B1_05 to value 0x05"]
impl crate::Resettable for SW_MUX_CTL_PAD_GPIO_SD_B1_05_SPEC {
