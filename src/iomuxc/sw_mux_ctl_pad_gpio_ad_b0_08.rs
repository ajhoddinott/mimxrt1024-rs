#[doc = "Register `SW_MUX_CTL_PAD_GPIO_AD_B0_08` reader"]
pub struct R(crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_MUX_CTL_PAD_GPIO_AD_B0_08` writer"]
pub struct W(crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC>) -> Self {
        W(writer)
    }
}
...
#[repr(u8)]
pub enum MUX_MODE_A {
    #[doc = "0: Select mux mode: ALT0 mux port: ENET_TX_CLK of instance: enet"]
    ALT0 = 0,
    ...
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: KPP_COL00 of instance: kpp"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: ENET_REF_CLK1 of instance: enet"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO08 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: ARM_TXEV of instance: cm7_mxrt"]
    ALT6 = 6,
}
...
pub type MUX_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC, u8, MUX_MODE_A, 3, O>;
impl<'a, const O: u8> MUX_MODE_W<'a, O> {
    ...
    #[doc = "Select mux mode: ALT6 mux port: ARM_TXEV of instance: cm7_mxrt"]
    #[inline(always)]
...
pub type SION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC, SION_A, O>;
...
#[doc = "SW_MUX_CTL_PAD_GPIO_AD_B0_08 SW MUX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_mux_ctl_pad_gpio_ad_b0_08](index.html) module"]
pub struct SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC;
impl crate::RegisterSpec for SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_mux_ctl_pad_gpio_ad_b0_08::R](R) reader structure"]
impl crate::Readable for SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_mux_ctl_pad_gpio_ad_b0_08::W](W) writer structure"]
impl crate::Writable for SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_MUX_CTL_PAD_GPIO_AD_B0_08 to value 0x05"]
impl crate::Resettable for SW_MUX_CTL_PAD_GPIO_AD_B0_08_SPEC {
