#[doc = "Register `SW_MUX_CTL_PAD_GPIO_SD_B1_04` reader"]
pub struct R(crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_MUX_CTL_PAD_GPIO_SD_B1_04` writer"]
pub struct W(crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum MUX_MODE_A {
    ...
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: FLEXSPI_B_DATA01 of instance: flexspi_bus2bit"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: ENET_TX_CLK of instance: enet"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: ENET_REF_CLK1 of instance: enet"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: EWM_OUT_B of instance: ewm"]
    ALT4 = 4,
...
pub type MUX_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC, u8, MUX_MODE_A, 3, O>;
...
pub type SION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC, SION_A, O>;
...
#[doc = "SW_MUX_CTL_PAD_GPIO_SD_B1_04 SW MUX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_mux_ctl_pad_gpio_sd_b1_04](index.html) module"]
pub struct SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC;
impl crate::RegisterSpec for SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_mux_ctl_pad_gpio_sd_b1_04::R](R) reader structure"]
impl crate::Readable for SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_mux_ctl_pad_gpio_sd_b1_04::W](W) writer structure"]
impl crate::Writable for SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_MUX_CTL_PAD_GPIO_SD_B1_04 to value 0x05"]
impl crate::Resettable for SW_MUX_CTL_PAD_GPIO_SD_B1_04_SPEC {
