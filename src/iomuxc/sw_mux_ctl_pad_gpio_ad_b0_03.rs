#[doc = "Register `SW_MUX_CTL_PAD_GPIO_AD_B0_03` reader"]
pub struct R(crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_MUX_CTL_PAD_GPIO_AD_B0_03` writer"]
pub struct W(crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum MUX_MODE_A {
    ...
    ALT0 = 0,
    #[doc = "1: Select mux mode: ALT1 mux port: USDHC2_CD_B of instance: usdhc2"]
    ALT1 = 1,
    #[doc = "2: Select mux mode: ALT2 mux port: WDOG1_B of instance: wdog1"]
    ALT2 = 2,
    #[doc = "3: Select mux mode: ALT3 mux port: SAI1_MCLK of instance: sai1"]
    ALT3 = 3,
    #[doc = "4: Select mux mode: ALT4 mux port: USDHC1_WP of instance: usdhc1"]
    ALT4 = 4,
    #[doc = "5: Select mux mode: ALT5 mux port: GPIO1_IO03 of instance: gpio1"]
    ALT5 = 5,
    #[doc = "6: Select mux mode: ALT6 mux port: USB_OTG1_OC of instance: usb"]
    ALT6 = 6,
    #[doc = "7: Select mux mode: ALT7 mux port: CCM_PMIC_RDY of instance: ccm"]
    ALT7 = 7,
}
...
pub type MUX_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC, u8, MUX_MODE_A, 3, O>;
...
pub type SION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC, SION_A, O>;
...
#[doc = "SW_MUX_CTL_PAD_GPIO_AD_B0_03 SW MUX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_mux_ctl_pad_gpio_ad_b0_03](index.html) module"]
pub struct SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC;
impl crate::RegisterSpec for SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_mux_ctl_pad_gpio_ad_b0_03::R](R) reader structure"]
impl crate::Readable for SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_mux_ctl_pad_gpio_ad_b0_03::W](W) writer structure"]
impl crate::Writable for SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_MUX_CTL_PAD_GPIO_AD_B0_03 to value 0"]
impl crate::Resettable for SW_MUX_CTL_PAD_GPIO_AD_B0_03_SPEC {
