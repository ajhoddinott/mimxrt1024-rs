...
#[doc = "Field `VECTRESET` writer - Writing 1 to this bit causes a local system reset"]
pub type VECTRESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, AIRCR_SPEC, VECTRESET_AW, O>;
impl<'a, const O: u8> VECTRESET_W<'a, O> {
    #[doc = "No change"]
    #[inline(always)]
...
#[doc = "Field `VECTCLRACTIVE` writer - Writing 1 to this bit clears all active state information for fixed and configurable exceptions."]
pub type VECTCLRACTIVE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, AIRCR_SPEC, VECTCLRACTIVE_AW, O>;
impl<'a, const O: u8> VECTCLRACTIVE_W<'a, O> {
    #[doc = "No change"]
    #[inline(always)]
