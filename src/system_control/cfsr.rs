...
#[doc = "Field `MLSPERR` reader - MemManage fault occurred during floating-point lazy state preservation"]
...
#[doc = "Field `MLSPERR` writer - MemManage fault occurred during floating-point lazy state preservation"]
...
#[doc = "Field `LSPERR` reader - Bus fault occurred during floating-point lazy state preservation"]
...
#[doc = "Field `LSPERR` writer - Bus fault occurred during floating-point lazy state preservation"]
