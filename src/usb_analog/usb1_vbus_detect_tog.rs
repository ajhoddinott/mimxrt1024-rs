...
pub type VBUSVALID_THRESH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, USB1_VBUS_DETECT_TOG_SPEC, u8, VBUSVALID_THRESH_A, 3, O>;
...
pub type VBUSVALID_PWRUP_CMPS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_TOG_SPEC, bool, O>;
...
#[doc = "`reset()` method sets USB1_VBUS_DETECT_TOG to value 0x0010_0004"]
