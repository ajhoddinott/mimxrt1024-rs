...
impl From<crate::R<USB1_VBUS_DETECT_CLR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<USB1_VBUS_DETECT_CLR_SPEC>> for W {
    #[inline(always)]
...
pub type VBUSVALID_THRESH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, u8, VBUSVALID_THRESH_A, 3, O>;
...
pub type VBUSVALID_PWRUP_CMPS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, bool, O>;
...
pub type CHARGE_VBUS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_VBUS_DETECT_CLR_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets USB1_VBUS_DETECT_CLR to value 0x0010_0004"]
