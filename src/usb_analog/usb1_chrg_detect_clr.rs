...
pub type CHK_CONTACT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_CHRG_DETECT_CLR_SPEC, CHK_CONTACT_A, O>;
...
pub type CHK_CHRG_B_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, USB1_CHRG_DETECT_CLR_SPEC, CHK_CHRG_B_A, O>;
...
pub type EN_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB1_CHRG_DETECT_CLR_SPEC, EN_B_A, O>;
