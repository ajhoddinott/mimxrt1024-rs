...
#[doc = "Field `L2_MEM_EN_POWERSAVING` reader - Enable power saving features on L2 memory"]
pub type L2_MEM_EN_POWERSAVING_R = crate::BitReader<L2_MEM_EN_POWERSAVING_A>;
#[doc = "Enable power saving features on L2 memory\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum L2_MEM_EN_POWERSAVING_A {
    #[doc = "0: Enters power saving mode only when chip is in SUSPEND mode"]
    L2_MEM_EN_POWERSAVING_0 = 0,
    #[doc = "1: Controlled by L2_MEM_DEEPSLEEP bitfield"]
...
#[doc = "Field `L2_MEM_EN_POWERSAVING` writer - Enable power saving features on L2 memory"]
pub type L2_MEM_EN_POWERSAVING_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, L2_MEM_EN_POWERSAVING_A, O>;
impl<'a, const O: u8> L2_MEM_EN_POWERSAVING_W<'a, O> {
...
#[doc = "Field `RAM_AUTO_CLK_GATING_EN` reader - Automatically gate off RAM clock when RAM is not accessed."]
pub type RAM_AUTO_CLK_GATING_EN_R = crate::BitReader<RAM_AUTO_CLK_GATING_EN_A>;
...
#[doc = "Field `RAM_AUTO_CLK_GATING_EN` writer - Automatically gate off RAM clock when RAM is not accessed."]
pub type RAM_AUTO_CLK_GATING_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, RAM_AUTO_CLK_GATING_EN_A, O>;
impl<'a, const O: u8> RAM_AUTO_CLK_GATING_EN_W<'a, O> {
...
#[doc = "Field `L2_MEM_DEEPSLEEP` reader - This bit controls how memory (OCRAM) enters Deep Sleep mode (shutdown periphery power, but maintain memory contents, outputs of memory are pulled low"]
pub type L2_MEM_DEEPSLEEP_R = crate::BitReader<L2_MEM_DEEPSLEEP_A>;
...
pub enum L2_MEM_DEEPSLEEP_A {
    #[doc = "0: No force sleep control supported, memory deep sleep mode only entered when whole system in stop mode (OCRAM in normal mode)"]
    L2_MEM_DEEPSLEEP_0 = 0,
    #[doc = "1: Force memory into deep sleep mode (OCRAM in power saving mode)"]
...
#[doc = "Field `L2_MEM_DEEPSLEEP` writer - This bit controls how memory (OCRAM) enters Deep Sleep mode (shutdown periphery power, but maintain memory contents, outputs of memory are pulled low"]
pub type L2_MEM_DEEPSLEEP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, L2_MEM_DEEPSLEEP_A, O>;
impl<'a, const O: u8> L2_MEM_DEEPSLEEP_W<'a, O> {
...
#[doc = "Field `MQS_CLK_DIV` reader - Divider ratio control for mclk from hmclk. mclk frequency = 1/(n+1) * hmclk frequency."]
pub type MQS_CLK_DIV_R = crate::FieldReader<u8, MQS_CLK_DIV_A>;
...
#[doc = "Field `MQS_CLK_DIV` writer - Divider ratio control for mclk from hmclk. mclk frequency = 1/(n+1) * hmclk frequency."]
pub type MQS_CLK_DIV_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPR2_SPEC, u8, MQS_CLK_DIV_A, 8, O>;
impl<'a, const O: u8> MQS_CLK_DIV_W<'a, O> {
...
#[doc = "Field `MQS_SW_RST` reader - MQS software reset"]
pub type MQS_SW_RST_R = crate::BitReader<MQS_SW_RST_A>;
...
#[doc = "Field `MQS_SW_RST` writer - MQS software reset"]
pub type MQS_SW_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPR2_SPEC, MQS_SW_RST_A, O>;
impl<'a, const O: u8> MQS_SW_RST_W<'a, O> {
...
#[doc = "Field `MQS_EN` reader - MQS enable."]
pub type MQS_EN_R = crate::BitReader<MQS_EN_A>;
#[doc = "MQS enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MQS_EN_A {
    #[doc = "0: Disable MQS"]
...
#[doc = "Field `MQS_EN` writer - MQS enable."]
pub type MQS_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPR2_SPEC, MQS_EN_A, O>;
impl<'a, const O: u8> MQS_EN_W<'a, O> {
    #[doc = "Disable MQS"]
    #[inline(always)]
...
#[doc = "Field `MQS_OVERSAMPLE` reader - Medium Quality Sound (MQS) Oversample"]
pub type MQS_OVERSAMPLE_R = crate::BitReader<MQS_OVERSAMPLE_A>;
...
#[doc = "Field `MQS_OVERSAMPLE` writer - Medium Quality Sound (MQS) Oversample"]
pub type MQS_OVERSAMPLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, MQS_OVERSAMPLE_A, O>;
impl<'a, const O: u8> MQS_OVERSAMPLE_W<'a, O> {
    #[doc = "32"]
    #[inline(always)]
...
#[doc = "Field `QTIMER1_TMR_CNTS_FREEZE` reader - QTIMER1 timer counter freeze"]
pub type QTIMER1_TMR_CNTS_FREEZE_R = crate::BitReader<QTIMER1_TMR_CNTS_FREEZE_A>;
#[doc = "QTIMER1 timer counter freeze\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum QTIMER1_TMR_CNTS_FREEZE_A {
    #[doc = "0: Timer counter works normally"]
...
#[doc = "Field `QTIMER1_TMR_CNTS_FREEZE` writer - QTIMER1 timer counter freeze"]
pub type QTIMER1_TMR_CNTS_FREEZE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, QTIMER1_TMR_CNTS_FREEZE_A, O>;
impl<'a, const O: u8> QTIMER1_TMR_CNTS_FREEZE_W<'a, O> {
...
#[doc = "Field `QTIMER2_TMR_CNTS_FREEZE` reader - QTIMER2 timer counter freeze"]
pub type QTIMER2_TMR_CNTS_FREEZE_R = crate::BitReader<QTIMER2_TMR_CNTS_FREEZE_A>;
...
#[doc = "Field `QTIMER2_TMR_CNTS_FREEZE` writer - QTIMER2 timer counter freeze"]
pub type QTIMER2_TMR_CNTS_FREEZE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPR2_SPEC, QTIMER2_TMR_CNTS_FREEZE_A, O>;
impl<'a, const O: u8> QTIMER2_TMR_CNTS_FREEZE_W<'a, O> {
    #[doc = "Timer counter works normally"]
    #[inline(always)]
...
impl R {
    ...
    pub fn l2_mem_en_powersaving(&self) -> L2_MEM_EN_POWERSAVING_R {
        L2_MEM_EN_POWERSAVING_R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn ram_auto_clk_gating_en(&self) -> RAM_AUTO_CLK_GATING_EN_R {
        RAM_AUTO_CLK_GATING_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - This bit controls how memory (OCRAM) enters Deep Sleep mode (shutdown periphery power, but maintain memory contents, outputs of memory are pulled low"]
    #[inline(always)]
    pub fn l2_mem_deepsleep(&self) -> L2_MEM_DEEPSLEEP_R {
        L2_MEM_DEEPSLEEP_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l2_mem_en_powersaving(&mut self) -> L2_MEM_EN_POWERSAVING_W<12> {
        L2_MEM_EN_POWERSAVING_W::new(self)
    }
    #[doc = "Bit 13 - Automatically gate off RAM clock when RAM is not accessed."]
    #[inline(always)]
    #[must_use]
    pub fn ram_auto_clk_gating_en(&mut self) -> RAM_AUTO_CLK_GATING_EN_W<13> {
        RAM_AUTO_CLK_GATING_EN_W::new(self)
    }
    #[doc = "Bit 14 - This bit controls how memory (OCRAM) enters Deep Sleep mode (shutdown periphery power, but maintain memory contents, outputs of memory are pulled low"]
    #[inline(always)]
    #[must_use]
    pub fn l2_mem_deepsleep(&mut self) -> L2_MEM_DEEPSLEEP_W<14> {
        L2_MEM_DEEPSLEEP_W::new(self)
    }
    #[doc = "Bits 16:23 - Divider ratio control for mclk from hmclk. mclk frequency = 1/(n+1) * hmclk frequency."]
    #[inline(always)]
    #[must_use]
    pub fn mqs_clk_div(&mut self) -> MQS_CLK_DIV_W<16> {
        MQS_CLK_DIV_W::new(self)
    }
    #[doc = "Bit 24 - MQS software reset"]
    #[inline(always)]
    #[must_use]
    pub fn mqs_sw_rst(&mut self) -> MQS_SW_RST_W<24> {
        MQS_SW_RST_W::new(self)
    }
    #[doc = "Bit 25 - MQS enable."]
    #[inline(always)]
    #[must_use]
    pub fn mqs_en(&mut self) -> MQS_EN_W<25> {
        MQS_EN_W::new(self)
    }
    #[doc = "Bit 26 - Medium Quality Sound (MQS) Oversample"]
    #[inline(always)]
    #[must_use]
    pub fn mqs_oversample(&mut self) -> MQS_OVERSAMPLE_W<26> {
        MQS_OVERSAMPLE_W::new(self)
    }
    #[doc = "Bit 28 - QTIMER1 timer counter freeze"]
    #[inline(always)]
    #[must_use]
    pub fn qtimer1_tmr_cnts_freeze(&mut self) -> QTIMER1_TMR_CNTS_FREEZE_W<28> {
        QTIMER1_TMR_CNTS_FREEZE_W::new(self)
    }
    #[doc = "Bit 29 - QTIMER2 timer counter freeze"]
    #[inline(always)]
    #[must_use]
    pub fn qtimer2_tmr_cnts_freeze(&mut self) -> QTIMER2_TMR_CNTS_FREEZE_W<29> {
        QTIMER2_TMR_CNTS_FREEZE_W::new(self)
    }
