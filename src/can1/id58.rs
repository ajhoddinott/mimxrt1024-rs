#[doc = "Register `ID58` reader"]
pub struct R(crate::R<ID58_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID58_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID58_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID58_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID58` writer"]
pub struct W(crate::W<ID58_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID58_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID58_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID58_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID58_SPEC, u32, u32, 18, O>;
...
pub type STD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID58_SPEC, u16, u16, 11, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID58_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "Message Buffer 58 ID Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [id58](index.html) module"]
pub struct ID58_SPEC;
impl crate::RegisterSpec for ID58_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [id58::R](R) reader structure"]
impl crate::Readable for ID58_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [id58::W](W) writer structure"]
impl crate::Writable for ID58_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ID58 to value 0"]
impl crate::Resettable for ID58_SPEC {
