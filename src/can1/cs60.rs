#[doc = "Register `CS60` reader"]
pub struct R(crate::R<CS60_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CS60_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CS60_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CS60_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CS60` writer"]
pub struct W(crate::W<CS60_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CS60_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CS60_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CS60_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TIME_STAMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS60_SPEC, u16, u16, 16, O>;
...
pub type DLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS60_SPEC, u8, u8, 4, O>;
...
pub type RTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS60_SPEC, bool, O>;
...
pub type IDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS60_SPEC, bool, O>;
...
pub type SRR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CS60_SPEC, bool, O>;
#[doc = "Field `CODE` reader - Reserved"]
pub type CODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CODE` writer - Reserved"]
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CS60_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "Message Buffer 60 CS Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cs60](index.html) module"]
pub struct CS60_SPEC;
impl crate::RegisterSpec for CS60_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cs60::R](R) reader structure"]
impl crate::Readable for CS60_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cs60::W](W) writer structure"]
impl crate::Writable for CS60_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CS60 to value 0"]
impl crate::Resettable for CS60_SPEC {
