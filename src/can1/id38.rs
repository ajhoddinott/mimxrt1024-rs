#[doc = "Register `ID38` reader"]
pub struct R(crate::R<ID38_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID38_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID38_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID38_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID38` writer"]
pub struct W(crate::W<ID38_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID38_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID38_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID38_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID38_SPEC, u32, u32, 18, O>;
...
pub type STD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID38_SPEC, u16, u16, 11, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID38_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "Message Buffer 38 ID Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [id38](index.html) module"]
pub struct ID38_SPEC;
impl crate::RegisterSpec for ID38_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [id38::R](R) reader structure"]
impl crate::Readable for ID38_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [id38::W](W) writer structure"]
impl crate::Writable for ID38_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ID38 to value 0"]
impl crate::Resettable for ID38_SPEC {
