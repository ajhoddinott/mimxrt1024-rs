#[doc = "Register `ID18` reader"]
pub struct R(crate::R<ID18_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ID18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ID18_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ID18_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ID18` writer"]
pub struct W(crate::W<ID18_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ID18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ID18_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ID18_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID18_SPEC, u32, u32, 18, O>;
...
pub type STD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID18_SPEC, u16, u16, 11, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ID18_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "Message Buffer 18 ID Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [id18](index.html) module"]
pub struct ID18_SPEC;
impl crate::RegisterSpec for ID18_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [id18::R](R) reader structure"]
impl crate::Readable for ID18_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [id18::W](W) writer structure"]
impl crate::Writable for ID18_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ID18 to value 0"]
impl crate::Resettable for ID18_SPEC {
