#[doc = "Register `WORD062` reader"]
pub struct R(crate::R<WORD062_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WORD062_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WORD062_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WORD062_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WORD062` writer"]
pub struct W(crate::W<WORD062_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WORD062_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WORD062_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WORD062_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_BYTE_3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD062_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD062_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD062_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD062_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Message Buffer 62 WORD0 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [word062](index.html) module"]
pub struct WORD062_SPEC;
impl crate::RegisterSpec for WORD062_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [word062::R](R) reader structure"]
impl crate::Readable for WORD062_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [word062::W](W) writer structure"]
impl crate::Writable for WORD062_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets WORD062 to value 0"]
impl crate::Resettable for WORD062_SPEC {
