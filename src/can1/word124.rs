...
pub struct R(crate::R<WORD124_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WORD124_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WORD124_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WORD124_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WORD124` writer"]
pub struct W(crate::W<WORD124_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WORD124_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WORD124_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WORD124_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_BYTE_7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD124_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD124_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD124_SPEC, u8, u8, 8, O>;
...
pub type DATA_BYTE_4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WORD124_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Message Buffer 24 WORD1 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [word124](index.html) module"]
pub struct WORD124_SPEC;
impl crate::RegisterSpec for WORD124_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [word124::R](R) reader structure"]
impl crate::Readable for WORD124_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [word124::W](W) writer structure"]
impl crate::Writable for WORD124_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets WORD124 to value 0"]
impl crate::Resettable for WORD124_SPEC {
