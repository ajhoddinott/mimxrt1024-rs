...
#[doc = "Field `TXCRC` reader - This field indicates the CRC value of the last message transmitted"]
pub type TXCRC_R = crate::FieldReader<u16, u16>;
#[doc = "Field `MBCRC` reader - This field indicates the number of the Mailbox corresponding to the value in TXCRC field."]
