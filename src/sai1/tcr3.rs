...
pub type TCE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TCE` writer - Transmit Channel Enable"]
pub type TCE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR3_SPEC, u8, u8, 4, O>;
#[doc = "Field `CFR` reader - Channel FIFO Reset"]
pub type CFR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CFR` writer - Channel FIFO Reset"]
pub type CFR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCR3_SPEC, u8, u8, 4, O>;
impl R {
