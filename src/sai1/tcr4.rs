...
impl FCOMB_R {
    ...
    pub fn variant(&self) -> FCOMB_A {
        match self.bits {
            0 => FCOMB_A::DISABLED,
            1 => FCOMB_A::ENABLED_ON_FIFO_READS,
            2 => FCOMB_A::ENABLED_ON_FIFO_WRITES,
            3 => FCOMB_A::ENABLED_ON_FIFO_READS_WRITES,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    ...
    #[doc = "Checks if the value of the field is `ENABLED_ON_FIFO_READS`"]
    #[inline(always)]
    pub fn is_enabled_on_fifo_reads(&self) -> bool {
        *self == FCOMB_A::ENABLED_ON_FIFO_READS
    }
    #[doc = "Checks if the value of the field is `ENABLED_ON_FIFO_WRITES`"]
    #[inline(always)]
    pub fn is_enabled_on_fifo_writes(&self) -> bool {
        *self == FCOMB_A::ENABLED_ON_FIFO_WRITES
    }
    #[doc = "Checks if the value of the field is `ENABLED_ON_FIFO_READS_WRITES`"]
    #[inline(always)]
    pub fn is_enabled_on_fifo_reads_writes(&self) -> bool {
        *self == FCOMB_A::ENABLED_ON_FIFO_READS_WRITES
    }
}
#[doc = "Field `FCOMB` writer - FIFO Combine Mode"]
pub type FCOMB_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, TCR4_SPEC, u8, FCOMB_A, 2, O>;
impl<'a, const O: u8> FCOMB_W<'a, O> {
    ...
    #[inline(always)]
    pub fn enabled_on_fifo_reads(self) -> &'a mut W {
        self.variant(FCOMB_A::ENABLED_ON_FIFO_READS)
    }
    #[doc = "FIFO combine mode enabled on FIFO writes (by software)."]
    #[inline(always)]
    pub fn enabled_on_fifo_writes(self) -> &'a mut W {
        self.variant(FCOMB_A::ENABLED_ON_FIFO_WRITES)
    }
    #[doc = "FIFO combine mode enabled on FIFO reads (from transmit shift registers) and writes (by software)."]
    #[inline(always)]
    pub fn enabled_on_fifo_reads_writes(self) -> &'a mut W {
        self.variant(FCOMB_A::ENABLED_ON_FIFO_READS_WRITES)
    }
}
