...
pub struct R(crate::R<AHBRXBUF3CR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AHBRXBUF3CR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AHBRXBUF3CR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AHBRXBUF3CR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AHBRXBUF3CR0` writer"]
pub struct W(crate::W<AHBRXBUF3CR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AHBRXBUF3CR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AHBRXBUF3CR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AHBRXBUF3CR0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BUFSZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF3CR0_SPEC, u8, u8, 8, O>;
...
pub type MSTRID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF3CR0_SPEC, u8, u8, 4, O>;
...
pub type PRIORITY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AHBRXBUF3CR0_SPEC, u8, u8, 2, O>;
...
pub type REGIONEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBRXBUF3CR0_SPEC, bool, O>;
...
pub type PREFETCHEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHBRXBUF3CR0_SPEC, bool, O>;
impl R {
...
pub struct AHBRXBUF3CR0_SPEC;
impl crate::RegisterSpec for AHBRXBUF3CR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ahbrxbuf3cr0::R](R) reader structure"]
impl crate::Readable for AHBRXBUF3CR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ahbrxbuf3cr0::W](W) writer structure"]
impl crate::Writable for AHBRXBUF3CR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AHBRXBUF3CR0 to value 0x8003_0020"]
impl crate::Resettable for AHBRXBUF3CR0_SPEC {
    const RESET_VALUE: Self::Ux = 0x8003_0020;
}
