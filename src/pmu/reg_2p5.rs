#[doc = "Register `REG_2P5` reader"]
pub struct R(crate::R<REG_2P5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REG_2P5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REG_2P5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REG_2P5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REG_2P5` writer"]
pub struct W(crate::W<REG_2P5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REG_2P5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REG_2P5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REG_2P5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_LINREG_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_2P5_SPEC, bool, O>;
...
pub type ENABLE_BO_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_2P5_SPEC, bool, O>;
...
pub type ENABLE_ILIMIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_2P5_SPEC, bool, O>;
...
pub type ENABLE_PULLDOWN_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_2P5_SPEC, bool, O>;
...
pub type BO_OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, REG_2P5_SPEC, u8, u8, 3, O>;
...
pub type OUTPUT_TRG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REG_2P5_SPEC, u8, OUTPUT_TRG_A, 5, O>;
...
pub type ENABLE_WEAK_LINREG_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_2P5_SPEC, bool, O>;
impl R {
...
#[doc = "Regulator 2P5 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reg_2p5](index.html) module"]
pub struct REG_2P5_SPEC;
impl crate::RegisterSpec for REG_2P5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reg_2p5::R](R) reader structure"]
impl crate::Readable for REG_2P5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reg_2p5::W](W) writer structure"]
impl crate::Writable for REG_2P5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets REG_2P5 to value 0x1073"]
impl crate::Resettable for REG_2P5_SPEC {
