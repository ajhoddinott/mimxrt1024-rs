#[doc = "Register `REG_3P0_TOG` reader"]
pub struct R(crate::R<REG_3P0_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REG_3P0_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REG_3P0_TOG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REG_3P0_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REG_3P0_TOG` writer"]
pub struct W(crate::W<REG_3P0_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REG_3P0_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REG_3P0_TOG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REG_3P0_TOG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_LINREG_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_3P0_TOG_SPEC, bool, O>;
...
pub type ENABLE_BO_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_3P0_TOG_SPEC, bool, O>;
...
pub type ENABLE_ILIMIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_3P0_TOG_SPEC, bool, O>;
...
pub type BO_OFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, REG_3P0_TOG_SPEC, u8, u8, 3, O>;
...
pub type VBUS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, REG_3P0_TOG_SPEC, VBUS_SEL_A, O>;
...
pub type OUTPUT_TRG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REG_3P0_TOG_SPEC, u8, OUTPUT_TRG_A, 5, O>;
...
#[doc = "Regulator 3P0 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reg_3p0_tog](index.html) module"]
pub struct REG_3P0_TOG_SPEC;
impl crate::RegisterSpec for REG_3P0_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reg_3p0_tog::R](R) reader structure"]
impl crate::Readable for REG_3P0_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reg_3p0_tog::W](W) writer structure"]
impl crate::Writable for REG_3P0_TOG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets REG_3P0_TOG to value 0x0f74"]
impl crate::Resettable for REG_3P0_TOG_SPEC {
