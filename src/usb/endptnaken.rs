...
#[doc = "Field `EPRNE` reader - RX Endpoint NAK Enable - R/W"]
pub type EPRNE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EPRNE` writer - RX Endpoint NAK Enable - R/W"]
pub type EPRNE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ENDPTNAKEN_SPEC, u8, u8, 8, O>;
#[doc = "Field `EPTNE` reader - TX Endpoint NAK Enable - R/W"]
pub type EPTNE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EPTNE` writer - TX Endpoint NAK Enable - R/W"]
