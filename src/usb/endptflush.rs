...
#[doc = "Field `FERB` reader - Flush Endpoint Receive Buffer - R/WS"]
pub type FERB_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FERB` writer - Flush Endpoint Receive Buffer - R/WS"]
pub type FERB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ENDPTFLUSH_SPEC, u8, u8, 8, O>;
#[doc = "Field `FETB` reader - Flush Endpoint Transmit Buffer - R/WS"]
pub type FETB_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FETB` writer - Flush Endpoint Transmit Buffer - R/WS"]
