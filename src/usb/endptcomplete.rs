...
#[doc = "Field `ERCE` reader - Endpoint Receive Complete Event - RW/C"]
pub type ERCE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ERCE` writer - Endpoint Receive Complete Event - RW/C"]
pub type ERCE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ENDPTCOMPLETE_SPEC, u8, u8, 8, O>;
#[doc = "Field `ETCE` reader - Endpoint Transmit Complete Event - R/WC"]
pub type ETCE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ETCE` writer - Endpoint Transmit Complete Event - R/WC"]
