...
pub type GPTCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPTIMER0CTRL_SPEC, u32, u32, 24, O>;
#[doc = "Field `GPTMODE` reader - General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an interrupt, and stop until the counter is reset by software; In repeat mode, the timer will count down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to start again"]
...
#[doc = "Field `GPTMODE` writer - General Purpose Timer Mode In one shot mode, the timer will count down to zero, generate an interrupt, and stop until the counter is reset by software; In repeat mode, the timer will count down to zero, generate an interrupt and automatically reload the counter value from GPTLD bits to start again"]
pub type GPTMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPTIMER0CTRL_SPEC, GPTMODE_A, O>;
...
pub type GPTRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPTIMER0CTRL_SPEC, GPTRST_A, O>;
...
pub type GPTRUN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPTIMER0CTRL_SPEC, GPTRUN_A, O>;
