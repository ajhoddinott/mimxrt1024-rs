...
#[doc = "Field `GPTLD` reader - General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is set '1b'"]
pub type GPTLD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `GPTLD` writer - General Purpose Timer Load Value These bit fields are loaded to GPTCNT bits when GPTRST bit is set '1b'"]
