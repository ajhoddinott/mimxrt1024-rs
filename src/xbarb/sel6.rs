...
#[doc = "Field `SEL12` reader - Input (XBARB_INn) to be muxed to XBARB_OUT12 (refer to Functional Description section for input/output assignment)"]
pub type SEL12_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL12` writer - Input (XBARB_INn) to be muxed to XBARB_OUT12 (refer to Functional Description section for input/output assignment)"]
pub type SEL12_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL6_SPEC, u8, u8, 6, O>;
#[doc = "Field `SEL13` reader - Input (XBARB_INn) to be muxed to XBARB_OUT13 (refer to Functional Description section for input/output assignment)"]
pub type SEL13_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL13` writer - Input (XBARB_INn) to be muxed to XBARB_OUT13 (refer to Functional Description section for input/output assignment)"]
pub type SEL13_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL6_SPEC, u8, u8, 6, O>;
impl R {
