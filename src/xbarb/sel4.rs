...
#[doc = "Field `SEL8` reader - Input (XBARB_INn) to be muxed to XBARB_OUT8 (refer to Functional Description section for input/output assignment)"]
pub type SEL8_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL8` writer - Input (XBARB_INn) to be muxed to XBARB_OUT8 (refer to Functional Description section for input/output assignment)"]
pub type SEL8_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL4_SPEC, u8, u8, 6, O>;
#[doc = "Field `SEL9` reader - Input (XBARB_INn) to be muxed to XBARB_OUT9 (refer to Functional Description section for input/output assignment)"]
pub type SEL9_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL9` writer - Input (XBARB_INn) to be muxed to XBARB_OUT9 (refer to Functional Description section for input/output assignment)"]
pub type SEL9_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL4_SPEC, u8, u8, 6, O>;
impl R {
