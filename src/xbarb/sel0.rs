...
#[doc = "Field `SEL0` reader - Input (XBARB_INn) to be muxed to XBARB_OUT0 (refer to Functional Description section for input/output assignment)"]
pub type SEL0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL0` writer - Input (XBARB_INn) to be muxed to XBARB_OUT0 (refer to Functional Description section for input/output assignment)"]
pub type SEL0_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL0_SPEC, u8, u8, 6, O>;
#[doc = "Field `SEL1` reader - Input (XBARB_INn) to be muxed to XBARB_OUT1 (refer to Functional Description section for input/output assignment)"]
pub type SEL1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL1` writer - Input (XBARB_INn) to be muxed to XBARB_OUT1 (refer to Functional Description section for input/output assignment)"]
pub type SEL1_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL0_SPEC, u8, u8, 6, O>;
impl R {
