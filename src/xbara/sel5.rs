...
#[doc = "Field `SEL10` reader - Input (XBARA_INn) to be muxed to XBARA_OUT10 (refer to Functional Description section for input/output assignment)"]
pub type SEL10_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL10` writer - Input (XBARA_INn) to be muxed to XBARA_OUT10 (refer to Functional Description section for input/output assignment)"]
pub type SEL10_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL5_SPEC, u8, u8, 7, O>;
#[doc = "Field `SEL11` reader - Input (XBARA_INn) to be muxed to XBARA_OUT11 (refer to Functional Description section for input/output assignment)"]
pub type SEL11_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL11` writer - Input (XBARA_INn) to be muxed to XBARA_OUT11 (refer to Functional Description section for input/output assignment)"]
pub type SEL11_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL5_SPEC, u8, u8, 7, O>;
impl R {
