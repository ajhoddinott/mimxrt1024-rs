...
#[doc = "Field `SEL2` reader - Input (XBARA_INn) to be muxed to XBARA_OUT2 (refer to Functional Description section for input/output assignment)"]
pub type SEL2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL2` writer - Input (XBARA_INn) to be muxed to XBARA_OUT2 (refer to Functional Description section for input/output assignment)"]
pub type SEL2_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL1_SPEC, u8, u8, 7, O>;
#[doc = "Field `SEL3` reader - Input (XBARA_INn) to be muxed to XBARA_OUT3 (refer to Functional Description section for input/output assignment)"]
pub type SEL3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL3` writer - Input (XBARA_INn) to be muxed to XBARA_OUT3 (refer to Functional Description section for input/output assignment)"]
pub type SEL3_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL1_SPEC, u8, u8, 7, O>;
impl R {
