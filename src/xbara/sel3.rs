...
#[doc = "Field `SEL6` reader - Input (XBARA_INn) to be muxed to XBARA_OUT6 (refer to Functional Description section for input/output assignment)"]
pub type SEL6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL6` writer - Input (XBARA_INn) to be muxed to XBARA_OUT6 (refer to Functional Description section for input/output assignment)"]
pub type SEL6_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL3_SPEC, u8, u8, 7, O>;
#[doc = "Field `SEL7` reader - Input (XBARA_INn) to be muxed to XBARA_OUT7 (refer to Functional Description section for input/output assignment)"]
pub type SEL7_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL7` writer - Input (XBARA_INn) to be muxed to XBARA_OUT7 (refer to Functional Description section for input/output assignment)"]
pub type SEL7_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL3_SPEC, u8, u8, 7, O>;
impl R {
