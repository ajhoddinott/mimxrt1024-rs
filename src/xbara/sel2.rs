...
#[doc = "Field `SEL4` reader - Input (XBARA_INn) to be muxed to XBARA_OUT4 (refer to Functional Description section for input/output assignment)"]
pub type SEL4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL4` writer - Input (XBARA_INn) to be muxed to XBARA_OUT4 (refer to Functional Description section for input/output assignment)"]
pub type SEL4_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL2_SPEC, u8, u8, 7, O>;
#[doc = "Field `SEL5` reader - Input (XBARA_INn) to be muxed to XBARA_OUT5 (refer to Functional Description section for input/output assignment)"]
pub type SEL5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL5` writer - Input (XBARA_INn) to be muxed to XBARA_OUT5 (refer to Functional Description section for input/output assignment)"]
pub type SEL5_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL2_SPEC, u8, u8, 7, O>;
impl R {
