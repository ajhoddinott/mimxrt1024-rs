...
#[doc = "Field `SEL14` reader - Input (XBARA_INn) to be muxed to XBARA_OUT14 (refer to Functional Description section for input/output assignment)"]
pub type SEL14_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL14` writer - Input (XBARA_INn) to be muxed to XBARA_OUT14 (refer to Functional Description section for input/output assignment)"]
pub type SEL14_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL7_SPEC, u8, u8, 7, O>;
#[doc = "Field `SEL15` reader - Input (XBARA_INn) to be muxed to XBARA_OUT15 (refer to Functional Description section for input/output assignment)"]
pub type SEL15_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEL15` writer - Input (XBARA_INn) to be muxed to XBARA_OUT15 (refer to Functional Description section for input/output assignment)"]
pub type SEL15_W<'a, const O: u8> = crate::FieldWriter<'a, u16, SEL7_SPEC, u8, u8, 7, O>;
impl R {
