...
pub type HREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, HREN_A, O>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HRPOL_A {
    #[doc = "0: HREQ pin is active high provided PCSPOL\\[1\\]
is clear"]
    DISABLED = 0,
    #[doc = "1: HREQ pin is active low provided PCSPOL\\[1\\]
is clear"]
    ENABLED = 1,
}
...
pub type HRPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, HRPOL_A, O>;
impl<'a, const O: u8> HRPOL_W<'a, O> {
    #[doc = "HREQ pin is active high provided PCSPOL\\[1\\]
is clear"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(HRPOL_A::DISABLED)
    }
    #[doc = "HREQ pin is active low provided PCSPOL\\[1\\]
is clear"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HRSEL_A {
    #[doc = "0: Host request input is the HREQ pin"]
    HREQPIN = 0,
...
pub type HRSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, HRSEL_A, O>;
...
pub type CIRFIFO_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, CIRFIFO_A, O>;
...
pub enum RDMO_A {
    ...
    STORED = 0,
    #[doc = "1: Received data is discarded unless the SR\\[DMF\\]
= 1"]
    DISCARDED = 1,
}
...
pub type RDMO_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, RDMO_A, O>;
impl<'a, const O: u8> RDMO_W<'a, O> {
    ...
    #[doc = "Received data is discarded unless the SR\\[DMF\\]
= 1"]
    #[inline(always)]
