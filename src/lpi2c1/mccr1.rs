...
pub type CLKLO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCCR1_SPEC, u8, u8, 6, O>;
#[doc = "Field `CLKHI` reader - Clock High Period"]
pub type CLKHI_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CLKHI` writer - Clock High Period"]
pub type CLKHI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCCR1_SPEC, u8, u8, 6, O>;
...
pub type SETHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCCR1_SPEC, u8, u8, 6, O>;
...
pub type DATAVD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCCR1_SPEC, u8, u8, 6, O>;
impl R {
