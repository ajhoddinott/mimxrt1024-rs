...
pub type MATCH0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MATCH0` writer - Match 0 Value"]
pub type MATCH0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMR_SPEC, u8, u8, 8, O>;
#[doc = "Field `MATCH1` reader - Match 1 Value"]
pub type MATCH1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MATCH1` writer - Match 1 Value"]
pub type MATCH1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMR_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn match0(&mut self) -> MATCH0_W<0> {
        MATCH0_W::new(self)
    }
    #[doc = "Bits 16:23 - Match 1 Value"]
    #[inline(always)]
    #[must_use]
    pub fn match1(&mut self) -> MATCH1_W<16> {
        MATCH1_W::new(self)
    }
