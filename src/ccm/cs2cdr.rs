#[doc = "Register `CS2CDR` reader"]
pub struct R(crate::R<CS2CDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CS2CDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CS2CDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CS2CDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CS2CDR` writer"]
pub struct W(crate::W<CS2CDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CS2CDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CS2CDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CS2CDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SAI2_CLK_PODF` reader - Divider for sai2 clock podf. The input clock to this divider should be lower than 300Mhz, the predivider can be used to achieve this."]
pub type SAI2_CLK_PODF_R = crate::FieldReader<u8, SAI2_CLK_PODF_A>;
...
#[doc = "Field `SAI2_CLK_PODF` writer - Divider for sai2 clock podf. The input clock to this divider should be lower than 300Mhz, the predivider can be used to achieve this."]
pub type SAI2_CLK_PODF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CS2CDR_SPEC, u8, SAI2_CLK_PODF_A, 6, O>;
impl<'a, const O: u8> SAI2_CLK_PODF_W<'a, O> {
    #[doc = "Divide by 1"]
    #[inline(always)]
...
#[doc = "Field `SAI2_CLK_PRED` reader - Divider for sai2 clock pred.Divider should be updated when output clock is gated."]
pub type SAI2_CLK_PRED_R = crate::FieldReader<u8, SAI2_CLK_PRED_A>;
...
#[doc = "Field `SAI2_CLK_PRED` writer - Divider for sai2 clock pred.Divider should be updated when output clock is gated."]
pub type SAI2_CLK_PRED_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CS2CDR_SPEC, u8, SAI2_CLK_PRED_A, 3, O>;
impl<'a, const O: u8> SAI2_CLK_PRED_W<'a, O> {
    #[doc = "divide by 1"]
    #[inline(always)]
...
impl R {
    ...
    pub fn sai2_clk_pred(&self) -> SAI2_CLK_PRED_R {
        SAI2_CLK_PRED_R::new(((self.bits >> 6) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - Divider for sai2 clock podf. The input clock to this divider should be lower than 300Mhz, the predivider can be used to achieve this."]
    #[inline(always)]
    #[must_use]
    pub fn sai2_clk_podf(&mut self) -> SAI2_CLK_PODF_W<0> {
        SAI2_CLK_PODF_W::new(self)
    }
    #[doc = "Bits 6:8 - Divider for sai2 clock pred.Divider should be updated when output clock is gated."]
    #[inline(always)]
    #[must_use]
    pub fn sai2_clk_pred(&mut self) -> SAI2_CLK_PRED_W<6> {
        SAI2_CLK_PRED_W::new(self)
    }
...
#[doc = "CCM Clock Divider Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cs2cdr](index.html) module"]
pub struct CS2CDR_SPEC;
impl crate::RegisterSpec for CS2CDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cs2cdr::R](R) reader structure"]
impl crate::Readable for CS2CDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cs2cdr::W](W) writer structure"]
impl crate::Writable for CS2CDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CS2CDR to value 0x0007_36c1"]
impl crate::Resettable for CS2CDR_SPEC {
    const RESET_VALUE: Self::Ux = 0x0007_36c1;
}
