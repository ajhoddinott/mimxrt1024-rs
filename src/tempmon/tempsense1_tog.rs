#[doc = "Register `TEMPSENSE1_TOG` reader"]
pub struct R(crate::R<TEMPSENSE1_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TEMPSENSE1_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TEMPSENSE1_TOG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TEMPSENSE1_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TEMPSENSE1_TOG` writer"]
pub struct W(crate::W<TEMPSENSE1_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPSENSE1_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPSENSE1_TOG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPSENSE1_TOG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MEASURE_FREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TEMPSENSE1_TOG_SPEC, u16, MEASURE_FREQ_A, 16, O>;
...
#[doc = "Tempsensor Control Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tempsense1_tog](index.html) module"]
pub struct TEMPSENSE1_TOG_SPEC;
impl crate::RegisterSpec for TEMPSENSE1_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tempsense1_tog::R](R) reader structure"]
impl crate::Readable for TEMPSENSE1_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tempsense1_tog::W](W) writer structure"]
impl crate::Writable for TEMPSENSE1_TOG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPSENSE1_TOG to value 0x01"]
impl crate::Resettable for TEMPSENSE1_TOG_SPEC {
