#[doc = "Register `TEMPSENSE2_TOG` reader"]
pub struct R(crate::R<TEMPSENSE2_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TEMPSENSE2_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TEMPSENSE2_TOG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TEMPSENSE2_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TEMPSENSE2_TOG` writer"]
pub struct W(crate::W<TEMPSENSE2_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPSENSE2_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPSENSE2_TOG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPSENSE2_TOG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOW_ALARM_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TEMPSENSE2_TOG_SPEC, u16, u16, 12, O>;
...
#[doc = "Tempsensor Control Register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tempsense2_tog](index.html) module"]
pub struct TEMPSENSE2_TOG_SPEC;
impl crate::RegisterSpec for TEMPSENSE2_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tempsense2_tog::R](R) reader structure"]
impl crate::Readable for TEMPSENSE2_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tempsense2_tog::W](W) writer structure"]
impl crate::Writable for TEMPSENSE2_TOG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPSENSE2_TOG to value 0"]
impl crate::Resettable for TEMPSENSE2_TOG_SPEC {
