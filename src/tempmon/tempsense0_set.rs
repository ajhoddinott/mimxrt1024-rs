#[doc = "Register `TEMPSENSE0_SET` reader"]
pub struct R(crate::R<TEMPSENSE0_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TEMPSENSE0_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TEMPSENSE0_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TEMPSENSE0_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TEMPSENSE0_SET` writer"]
pub struct W(crate::W<TEMPSENSE0_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPSENSE0_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPSENSE0_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPSENSE0_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type POWER_DOWN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TEMPSENSE0_SET_SPEC, POWER_DOWN_A, O>;
...
pub type MEASURE_TEMP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TEMPSENSE0_SET_SPEC, MEASURE_TEMP_A, O>;
...
pub type ALARM_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TEMPSENSE0_SET_SPEC, u16, u16, 12, O>;
impl R {
...
#[doc = "Tempsensor Control Register 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tempsense0_set](index.html) module"]
pub struct TEMPSENSE0_SET_SPEC;
impl crate::RegisterSpec for TEMPSENSE0_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tempsense0_set::R](R) reader structure"]
impl crate::Readable for TEMPSENSE0_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tempsense0_set::W](W) writer structure"]
impl crate::Writable for TEMPSENSE0_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPSENSE0_SET to value 0x01"]
impl crate::Resettable for TEMPSENSE0_SET_SPEC {
