...
#[doc = "Register `TEMPSENSE1` writer"]
pub struct W(crate::W<TEMPSENSE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPSENSE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPSENSE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPSENSE1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MEASURE_FREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TEMPSENSE1_SPEC, u16, MEASURE_FREQ_A, 16, O>;
...
#[doc = "`write(|w| ..)` method takes [tempsense1::W](W) writer structure"]
impl crate::Writable for TEMPSENSE1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPSENSE1 to value 0x01"]
