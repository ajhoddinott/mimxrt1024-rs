#[doc = "Register `TEMPSENSE1_SET` reader"]
pub struct R(crate::R<TEMPSENSE1_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TEMPSENSE1_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TEMPSENSE1_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TEMPSENSE1_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TEMPSENSE1_SET` writer"]
pub struct W(crate::W<TEMPSENSE1_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TEMPSENSE1_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TEMPSENSE1_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TEMPSENSE1_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MEASURE_FREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TEMPSENSE1_SET_SPEC, u16, MEASURE_FREQ_A, 16, O>;
...
#[doc = "Tempsensor Control Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tempsense1_set](index.html) module"]
pub struct TEMPSENSE1_SET_SPEC;
impl crate::RegisterSpec for TEMPSENSE1_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tempsense1_set::R](R) reader structure"]
impl crate::Readable for TEMPSENSE1_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tempsense1_set::W](W) writer structure"]
impl crate::Writable for TEMPSENSE1_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TEMPSENSE1_SET to value 0x01"]
impl crate::Resettable for TEMPSENSE1_SET_SPEC {
