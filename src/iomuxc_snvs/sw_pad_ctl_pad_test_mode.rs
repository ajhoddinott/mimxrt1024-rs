#[doc = "Register `SW_PAD_CTL_PAD_TEST_MODE` reader"]
pub struct R(crate::R<SW_PAD_CTL_PAD_TEST_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SW_PAD_CTL_PAD_TEST_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SW_PAD_CTL_PAD_TEST_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SW_PAD_CTL_PAD_TEST_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SW_PAD_CTL_PAD_TEST_MODE` writer"]
pub struct W(crate::W<SW_PAD_CTL_PAD_TEST_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SW_PAD_CTL_PAD_TEST_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SW_PAD_CTL_PAD_TEST_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SW_PAD_CTL_PAD_TEST_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, SRE_A, O>;
...
pub type DSE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, u8, DSE_A, 3, O>;
...
pub type ODE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, ODE_A, O>;
...
pub type PKE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, PKE_A, O>;
...
pub type PUE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, PUE_A, O>;
...
pub type PUS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, u8, PUS_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_PAD_CTL_PAD_TEST_MODE_SPEC, HYS_A, O>;
...
#[doc = "SW_PAD_CTL_PAD_TEST_MODE SW PAD Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sw_pad_ctl_pad_test_mode](index.html) module"]
pub struct SW_PAD_CTL_PAD_TEST_MODE_SPEC;
impl crate::RegisterSpec for SW_PAD_CTL_PAD_TEST_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sw_pad_ctl_pad_test_mode::R](R) reader structure"]
impl crate::Readable for SW_PAD_CTL_PAD_TEST_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sw_pad_ctl_pad_test_mode::W](W) writer structure"]
impl crate::Writable for SW_PAD_CTL_PAD_TEST_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SW_PAD_CTL_PAD_TEST_MODE to value 0x30a0"]
impl crate::Resettable for SW_PAD_CTL_PAD_TEST_MODE_SPEC {
