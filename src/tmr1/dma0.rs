#[doc = "Register `DMA0` reader"]
pub struct R(crate::R<DMA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA0` writer"]
pub struct W(crate::W<DMA0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IEFDE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMA0_SPEC, bool, O>;
...
pub type CMPLD1DE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMA0_SPEC, bool, O>;
...
pub type CMPLD2DE_W<'a, const O: u8> = crate::BitWriter<'a, u16, DMA0_SPEC, bool, O>;
impl R {
