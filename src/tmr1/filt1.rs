...
pub type FILT_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u16, FILT1_SPEC, u8, u8, 8, O>;
...
pub type FILT_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u16, FILT1_SPEC, u8, u8, 3, O>;
impl R {
