...
pub type OUTMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, CTRL1_SPEC, u8, OUTMODE_A, 3, O>;
...
pub type COINIT_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRL1_SPEC, COINIT_A, O>;
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRL1_SPEC, DIR_A, O>;
...
pub type LENGTH_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRL1_SPEC, LENGTH_A, O>;
...
pub type ONCE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CTRL1_SPEC, ONCE_A, O>;
...
pub type SCS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, CTRL1_SPEC, u8, SCS_A, 2, O>;
...
pub type PCS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, CTRL1_SPEC, u8, PCS_A, 4, O>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, CTRL1_SPEC, u8, CM_A, 3, O>;
