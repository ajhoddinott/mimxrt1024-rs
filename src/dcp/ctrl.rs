...
pub type CHANNEL_INTERRUPT_ENABLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CTRL_SPEC, u8, CHANNEL_INTERRUPT_ENABLE_A, 8, O>;
...
pub type ENABLE_CONTEXT_CACHING_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type GATHER_RESIDUAL_WRITES_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
#[doc = "`reset()` method sets CTRL to value 0xf080_0000"]
