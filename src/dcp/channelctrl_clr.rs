#[doc = "Register `CHANNELCTRL_CLR` reader"]
pub struct R(crate::R<CHANNELCTRL_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNELCTRL_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNELCTRL_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNELCTRL_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNELCTRL_CLR` writer"]
pub struct W(crate::W<CHANNELCTRL_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNELCTRL_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNELCTRL_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNELCTRL_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHANNELCTRL_CLR_SPEC, u8, ENABLE_CHANNEL_A, 8, O>;
...
pub type HIGH_PRIORITY_CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHANNELCTRL_CLR_SPEC, u8, HIGH_PRIORITY_CHANNEL_A, 8, O>;
...
pub type CH0_IRQ_MERGED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CHANNELCTRL_CLR_SPEC, bool, O>;
impl R {
...
#[doc = "DCP channel control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [channelctrl_clr](index.html) module"]
pub struct CHANNELCTRL_CLR_SPEC;
impl crate::RegisterSpec for CHANNELCTRL_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [channelctrl_clr::R](R) reader structure"]
impl crate::Readable for CHANNELCTRL_CLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channelctrl_clr::W](W) writer structure"]
impl crate::Writable for CHANNELCTRL_CLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHANNELCTRL_CLR to value 0"]
impl crate::Resettable for CHANNELCTRL_CLR_SPEC {
