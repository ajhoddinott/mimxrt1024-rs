...
#[doc = "Field `STEP` reader - Fixed read-only value reflecting the stepping of the version of the design implementation."]
pub type STEP_R = crate::FieldReader<u16, u16>;
#[doc = "Field `MINOR` reader - Fixed read-only value reflecting the MINOR version of the design implementation."]
pub type MINOR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MAJOR` reader - Fixed read-only value reflecting the MAJOR version of the design implementation."]
...
#[doc = "`reset()` method sets VERSION to value 0x0201_0000"]
impl crate::Resettable for VERSION_SPEC {
    const RESET_VALUE: Self::Ux = 0x0201_0000;
}
