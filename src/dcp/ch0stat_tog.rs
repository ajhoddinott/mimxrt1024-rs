#[doc = "Register `CH0STAT_TOG` reader"]
pub struct R(crate::R<CH0STAT_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH0STAT_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH0STAT_TOG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH0STAT_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH0STAT_TOG` writer"]
pub struct W(crate::W<CH0STAT_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH0STAT_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH0STAT_TOG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH0STAT_TOG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `HASH_MISMATCH` reader - This bit indicates that a hashing check operation mismatched for the control packets that enable the HASH_CHECK bit"]
pub type HASH_MISMATCH_R = crate::BitReader<bool>;
#[doc = "Field `HASH_MISMATCH` writer - This bit indicates that a hashing check operation mismatched for the control packets that enable the HASH_CHECK bit"]
pub type HASH_MISMATCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
...
pub type ERROR_SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
#[doc = "Field `ERROR_PACKET` reader - This bit indicates that a bus error occurred when reading the packet or payload, or when writing the status back to the packet payload"]
pub type ERROR_PACKET_R = crate::BitReader<bool>;
#[doc = "Field `ERROR_PACKET` writer - This bit indicates that a bus error occurred when reading the packet or payload, or when writing the status back to the packet payload"]
pub type ERROR_PACKET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
...
pub type ERROR_SRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
...
pub type ERROR_DST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
...
pub type ERROR_PAGEFAULT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH0STAT_TOG_SPEC, bool, O>;
#[doc = "Field `ERROR_CODE` reader - Indicates the additional error codes for some of the error conditions"]
...
#[doc = "Field `ERROR_CODE` writer - Indicates the additional error codes for some of the error conditions"]
pub type ERROR_CODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH0STAT_TOG_SPEC, u8, ERROR_CODE_A, 8, O>;
...
#[doc = "DCP channel 0 status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch0stat_tog](index.html) module"]
pub struct CH0STAT_TOG_SPEC;
impl crate::RegisterSpec for CH0STAT_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch0stat_tog::R](R) reader structure"]
impl crate::Readable for CH0STAT_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch0stat_tog::W](W) writer structure"]
impl crate::Writable for CH0STAT_TOG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH0STAT_TOG to value 0"]
impl crate::Resettable for CH0STAT_TOG_SPEC {
