...
impl TIF_R {
    ...
    pub fn variant(&self) -> TIF_A {
        match self.bits {
            false => TIF_A::T0022331,
            true => TIF_A::T0022332221,
        }
    }
    #[doc = "Checks if the value of the field is `T0022331`"]
    #[inline(always)]
    pub fn is_t0022331(&self) -> bool {
        *self == TIF_A::T0022331
    }
    #[doc = "Checks if the value of the field is `T0022332221`"]
    #[inline(always)]
    pub fn is_t0022332221(&self) -> bool {
        *self == TIF_A::T0022332221
    }
}
#[doc = "Field `TIF` writer - Timer Interrupt Flag"]
pub type TIF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TFLG_SPEC, TIF_A, O>;
impl<'a, const O: u8> TIF_W<'a, O> {
    #[doc = "Timeout has not yet occurred."]
    #[inline(always)]
    pub fn t0022331(self) -> &'a mut W {
        self.variant(TIF_A::T0022331)
    }
    #[doc = "Timeout has occurred."]
    #[inline(always)]
    pub fn t0022332221(self) -> &'a mut W {
        self.variant(TIF_A::T0022332221)
    }
}
impl R {
...
#[doc = "`reset()` method sets TFLG to value 0"]
