...
pub type RSVD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DEBUG1_SPEC, u16, u16, 13, O>;
...
pub type ENTAILADJVD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DEBUG1_SPEC, u8, u8, 2, O>;
