...
pub struct R(crate::R<DEBUG1_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEBUG1_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEBUG1_TOG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEBUG1_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DEBUG1_TOG` writer"]
pub struct W(crate::W<DEBUG1_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEBUG1_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DEBUG1_TOG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEBUG1_TOG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RSVD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DEBUG1_TOG_SPEC, u16, u16, 13, O>;
...
pub type ENTAILADJVD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEBUG1_TOG_SPEC, u8, u8, 2, O>;
...
pub struct DEBUG1_TOG_SPEC;
impl crate::RegisterSpec for DEBUG1_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [debug1_tog::R](R) reader structure"]
impl crate::Readable for DEBUG1_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [debug1_tog::W](W) writer structure"]
impl crate::Writable for DEBUG1_TOG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEBUG1_TOG to value 0x1000"]
impl crate::Resettable for DEBUG1_TOG_SPEC {
