...
pub type ENVADJ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RX_TOG_SPEC, u8, u8, 3, O>;
...
pub type DISCONADJ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RX_TOG_SPEC, u8, u8, 3, O>;
...
pub type RXDBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_TOG_SPEC, bool, O>;
