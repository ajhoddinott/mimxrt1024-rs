...
pub type D_CAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, u8, 4, O>;
...
pub type RSVD0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, u8, 4, O>;
...
pub type TXCAL45DN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, u8, 4, O>;
...
pub type RSVD1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, u8, 4, O>;
...
pub type USBPHY_TX_EDGECTRL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_TOG_SPEC, u8, u8, 3, O>;
...
#[doc = "`reset()` method sets TX_TOG to value 0x1006_0607"]
