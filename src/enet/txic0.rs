#[doc = "Register `TXIC0` reader"]
pub struct R(crate::R<TXIC0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXIC0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXIC0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXIC0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXIC0` writer"]
pub struct W(crate::W<TXIC0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXIC0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXIC0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXIC0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ICTT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TXIC0_SPEC, u16, u16, 16, O>;
...
pub type ICFT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TXIC0_SPEC, u8, u8, 8, O>;
...
pub type ICCS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TXIC0_SPEC, ICCS_A, O>;
...
pub type ICEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TXIC0_SPEC, ICEN_A, O>;
...
#[doc = "Transmit Interrupt Coalescing Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txic0](index.html) module"]
pub struct TXIC0_SPEC;
impl crate::RegisterSpec for TXIC0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [txic0::R](R) reader structure"]
impl crate::Readable for TXIC0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [txic0::W](W) writer structure"]
impl crate::Writable for TXIC0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TXIC0 to value 0"]
impl crate::Resettable for TXIC0_SPEC {
