...
pub type TF0_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TGSR_SPEC, TF0_A, O>;
impl<'a, const O: u8> TF0_W<'a, O> {
    #[doc = "Timer Flag for Channel 0 is clear"]
    #[inline(always)]
    pub fn zero(self) -> &'a mut W {
        self.variant(TF0_A::ZERO)
    }
    #[doc = "Timer Flag for Channel 0 is set"]
    #[inline(always)]
    pub fn one(self) -> &'a mut W {
        self.variant(TF0_A::ONE)
    }
}
...
pub type TF1_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TGSR_SPEC, TF1_A, O>;
impl<'a, const O: u8> TF1_W<'a, O> {
    #[doc = "Timer Flag for Channel 1 is clear"]
    #[inline(always)]
    pub fn zero(self) -> &'a mut W {
        self.variant(TF1_A::ZERO)
    }
    #[doc = "Timer Flag for Channel 1 is set"]
    #[inline(always)]
    pub fn one(self) -> &'a mut W {
        self.variant(TF1_A::ONE)
    }
}
...
pub type TF2_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TGSR_SPEC, TF2_A, O>;
impl<'a, const O: u8> TF2_W<'a, O> {
    #[doc = "Timer Flag for Channel 2 is clear"]
    #[inline(always)]
    pub fn zero(self) -> &'a mut W {
        self.variant(TF2_A::ZERO)
    }
    #[doc = "Timer Flag for Channel 2 is set"]
    #[inline(always)]
    pub fn one(self) -> &'a mut W {
        self.variant(TF2_A::ONE)
    }
}
...
pub type TF3_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TGSR_SPEC, TF3_A, O>;
impl<'a, const O: u8> TF3_W<'a, O> {
    #[doc = "Timer Flag for Channel 3 is clear"]
    #[inline(always)]
    pub fn zero(self) -> &'a mut W {
        self.variant(TF3_A::ZERO)
    }
    #[doc = "Timer Flag for Channel 3 is set"]
    #[inline(always)]
    pub fn one(self) -> &'a mut W {
        self.variant(TF3_A::ONE)
    }
}
impl R {
