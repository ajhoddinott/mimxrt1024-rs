#[doc = "Register `TCSR0` reader"]
pub struct R(crate::R<TCSR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCSR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCSR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCSR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCSR0` writer"]
pub struct W(crate::W<TCSR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCSR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCSR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCSR0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TDRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCSR0_SPEC, TDRE_A, O>;
...
pub type TMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCSR0_SPEC, u8, TMODE_A, 4, O>;
...
pub type TIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCSR0_SPEC, TIE_A, O>;
...
pub type TF_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, TCSR0_SPEC, TF_A, O>;
...
pub type TPWC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TCSR0_SPEC, u8, TPWC_A, 5, O>;
...
#[doc = "Timer Control Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcsr0](index.html) module"]
pub struct TCSR0_SPEC;
impl crate::RegisterSpec for TCSR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tcsr0::R](R) reader structure"]
impl crate::Readable for TCSR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcsr0::W](W) writer structure"]
impl crate::Writable for TCSR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x80;
}
#[doc = "`reset()` method sets TCSR0 to value 0"]
impl crate::Resettable for TCSR0_SPEC {
