...
impl<'a, const O: u8> SLEEP_W<'a, O> {
    ...
    #[inline(always)]
    pub fn zero(self) -> &'a mut W {
        self.variant(SLEEP_A::ZERO)
    }
    #[doc = "Sleep mode."]
    #[inline(always)]
    pub fn one(self) -> &'a mut W {
        self.variant(SLEEP_A::ONE)
    }
}
...
pub enum EN1588_A {
    ...
    ZERO = 0,
    #[doc = "1: Enhanced frame time-stamping functions enabled. Has no effect within the MAC besides controlling the DMA control bit ena_1588."]
    ONE = 1,
}
...
#[doc = "`reset()` method sets ECR to value 0x7000_0000"]
