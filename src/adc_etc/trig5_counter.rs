#[doc = "Register `TRIG5_COUNTER` reader"]
pub struct R(crate::R<TRIG5_COUNTER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRIG5_COUNTER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRIG5_COUNTER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRIG5_COUNTER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRIG5_COUNTER` writer"]
pub struct W(crate::W<TRIG5_COUNTER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRIG5_COUNTER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRIG5_COUNTER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRIG5_COUNTER_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INIT_DELAY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRIG5_COUNTER_SPEC, u16, u16, 16, O>;
...
#[doc = "ETC_TRIG Counter Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trig5_counter](index.html) module"]
pub struct TRIG5_COUNTER_SPEC;
impl crate::RegisterSpec for TRIG5_COUNTER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trig5_counter::R](R) reader structure"]
impl crate::Readable for TRIG5_COUNTER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [trig5_counter::W](W) writer structure"]
impl crate::Writable for TRIG5_COUNTER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TRIG5_COUNTER to value 0"]
impl crate::Resettable for TRIG5_COUNTER_SPEC {
