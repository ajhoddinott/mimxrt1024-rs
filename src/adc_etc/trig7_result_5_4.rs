#[doc = "Register `TRIG7_RESULT_5_4` reader"]
pub struct R(crate::R<TRIG7_RESULT_5_4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRIG7_RESULT_5_4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRIG7_RESULT_5_4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRIG7_RESULT_5_4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ETC_TRIG Result Data 5/4 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trig7_result_5_4](index.html) module"]
pub struct TRIG7_RESULT_5_4_SPEC;
impl crate::RegisterSpec for TRIG7_RESULT_5_4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trig7_result_5_4::R](R) reader structure"]
impl crate::Readable for TRIG7_RESULT_5_4_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TRIG7_RESULT_5_4 to value 0"]
impl crate::Resettable for TRIG7_RESULT_5_4_SPEC {
