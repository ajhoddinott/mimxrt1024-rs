#[doc = "Register `TRIG0_RESULT_3_2` reader"]
pub struct R(crate::R<TRIG0_RESULT_3_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRIG0_RESULT_3_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRIG0_RESULT_3_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRIG0_RESULT_3_2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ETC_TRIG Result Data 3/2 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trig0_result_3_2](index.html) module"]
pub struct TRIG0_RESULT_3_2_SPEC;
impl crate::RegisterSpec for TRIG0_RESULT_3_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trig0_result_3_2::R](R) reader structure"]
impl crate::Readable for TRIG0_RESULT_3_2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TRIG0_RESULT_3_2 to value 0"]
impl crate::Resettable for TRIG0_RESULT_3_2_SPEC {
