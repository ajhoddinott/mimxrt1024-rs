#[doc = "Register `TRIG0_CTRL` reader"]
pub struct R(crate::R<TRIG0_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRIG0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRIG0_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRIG0_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRIG0_CTRL` writer"]
pub struct W(crate::W<TRIG0_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRIG0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRIG0_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRIG0_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SW_TRIG_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIG0_CTRL_SPEC, SW_TRIG_A, O>;
...
pub type TRIG_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIG0_CTRL_SPEC, TRIG_MODE_A, O>;
...
pub type TRIG_CHAIN_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TRIG0_CTRL_SPEC, u8, TRIG_CHAIN_A, 3, O>;
...
pub type TRIG_PRIORITY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRIG0_CTRL_SPEC, u8, u8, 3, O>;
...
pub type SYNC_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIG0_CTRL_SPEC, SYNC_MODE_A, O>;
...
#[doc = "ETC_TRIG Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trig0_ctrl](index.html) module"]
pub struct TRIG0_CTRL_SPEC;
impl crate::RegisterSpec for TRIG0_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trig0_ctrl::R](R) reader structure"]
impl crate::Readable for TRIG0_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [trig0_ctrl::W](W) writer structure"]
impl crate::Writable for TRIG0_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TRIG0_CTRL to value 0"]
impl crate::Resettable for TRIG0_CTRL_SPEC {
