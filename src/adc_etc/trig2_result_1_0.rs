#[doc = "Register `TRIG2_RESULT_1_0` reader"]
pub struct R(crate::R<TRIG2_RESULT_1_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRIG2_RESULT_1_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRIG2_RESULT_1_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRIG2_RESULT_1_0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ETC_TRIG Result Data 1/0 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trig2_result_1_0](index.html) module"]
pub struct TRIG2_RESULT_1_0_SPEC;
impl crate::RegisterSpec for TRIG2_RESULT_1_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trig2_result_1_0::R](R) reader structure"]
impl crate::Readable for TRIG2_RESULT_1_0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TRIG2_RESULT_1_0 to value 0"]
impl crate::Resettable for TRIG2_RESULT_1_0_SPEC {
