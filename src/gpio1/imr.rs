...
#[doc = "Field `IMR` reader - Interrupt Mask bits"]
pub type IMR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `IMR` writer - Interrupt Mask bits"]
pub type IMR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IMR_SPEC, u32, u32, 32, O>;
impl R {
