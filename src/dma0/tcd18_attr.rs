#[doc = "Register `TCD18_ATTR` reader"]
pub struct R(crate::R<TCD18_ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD18_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD18_ATTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD18_ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD18_ATTR` writer"]
pub struct W(crate::W<TCD18_ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD18_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD18_ATTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD18_ATTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD18_ATTR_SPEC, u8, u8, 3, O>;
...
pub type DMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD18_ATTR_SPEC, u8, u8, 5, O>;
...
pub type SSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD18_ATTR_SPEC, u8, SSIZE_A, 3, O>;
...
pub type SMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD18_ATTR_SPEC, u8, SMOD_A, 5, O>;
...
#[doc = "TCD Transfer Attributes\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd18_attr](index.html) module"]
pub struct TCD18_ATTR_SPEC;
impl crate::RegisterSpec for TCD18_ATTR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd18_attr::R](R) reader structure"]
impl crate::Readable for TCD18_ATTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd18_attr::W](W) writer structure"]
impl crate::Writable for TCD18_ATTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TCD18_ATTR to value 0"]
impl crate::Resettable for TCD18_ATTR_SPEC {
