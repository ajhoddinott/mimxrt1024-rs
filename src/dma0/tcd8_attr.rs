...
pub type DSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD8_ATTR_SPEC, u8, u8, 3, O>;
...
pub type DMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD8_ATTR_SPEC, u8, u8, 5, O>;
...
pub type SSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD8_ATTR_SPEC, u8, SSIZE_A, 3, O>;
...
pub type SMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD8_ATTR_SPEC, u8, SMOD_A, 5, O>;
