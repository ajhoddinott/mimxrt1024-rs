#[doc = "Register `TCD26_CITER_ELINKYES` reader"]
pub struct R(crate::R<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD26_CITER_ELINKYES` writer"]
pub struct W(crate::W<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CITER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC, u16, u16, 9, O>;
...
pub type LINKCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC, u8, u8, 5, O>;
...
pub type ELINK_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC, ELINK_A, O>;
...
#[doc = "TCD Current Minor Loop Link, Major Loop Count (Channel Linking Enabled)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd_citer_elink_tcd26_citer_elinkyes](index.html) module"]
pub struct TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC;
impl crate::RegisterSpec for TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd_citer_elink_tcd26_citer_elinkyes::R](R) reader structure"]
impl crate::Readable for TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd_citer_elink_tcd26_citer_elinkyes::W](W) writer structure"]
impl crate::Writable for TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TCD26_CITER_ELINKYES to value 0"]
impl crate::Resettable for TCD_CITER_ELINK_TCD26_CITER_ELINKYES_SPEC {
