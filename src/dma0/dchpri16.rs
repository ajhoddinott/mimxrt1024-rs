#[doc = "Register `DCHPRI16` reader"]
pub struct R(crate::R<DCHPRI16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI16` writer"]
pub struct W(crate::W<DCHPRI16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI16_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHPRI_W<'a, const O: u8> = crate::FieldWriter<'a, u8, DCHPRI16_SPEC, u8, u8, 4, O>;
...
pub type DPA_W<'a, const O: u8> = crate::BitWriter<'a, u8, DCHPRI16_SPEC, DPA_A, O>;
...
pub type ECP_W<'a, const O: u8> = crate::BitWriter<'a, u8, DCHPRI16_SPEC, ECP_A, O>;
...
#[doc = "Channel Priority\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dchpri16](index.html) module"]
pub struct DCHPRI16_SPEC;
impl crate::RegisterSpec for DCHPRI16_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri16::R](R) reader structure"]
impl crate::Readable for DCHPRI16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri16::W](W) writer structure"]
impl crate::Writable for DCHPRI16_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DCHPRI16 to value 0x10"]
impl crate::Resettable for DCHPRI16_SPEC {
