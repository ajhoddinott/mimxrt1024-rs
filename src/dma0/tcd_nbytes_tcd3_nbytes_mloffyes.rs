...
pub struct R(crate::R<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD3_NBYTES_MLOFFYES` writer"]
pub struct W(crate::W<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NBYTES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC, u16, u16, 10, O>;
...
pub type MLOFF_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC, u32, u32, 20, O>;
...
pub type DMLOE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC, DMLOE_A, O>;
...
pub type SMLOE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC, SMLOE_A, O>;
...
#[doc = "TCD Signed Minor Loop Offset (Minor Loop Mapping and Offset Enabled)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd_nbytes_tcd3_nbytes_mloffyes](index.html) module"]
pub struct TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC;
impl crate::RegisterSpec for TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tcd_nbytes_tcd3_nbytes_mloffyes::R](R) reader structure"]
impl crate::Readable for TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd_nbytes_tcd3_nbytes_mloffyes::W](W) writer structure"]
impl crate::Writable for TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TCD3_NBYTES_MLOFFYES to value 0"]
impl crate::Resettable for TCD_NBYTES_TCD3_NBYTES_MLOFFYES_SPEC {
