...
pub type CHPRI_W<'a, const O: u8> = crate::FieldWriter<'a, u8, DCHPRI1_SPEC, u8, u8, 4, O>;
...
pub type DPA_W<'a, const O: u8> = crate::BitWriter<'a, u8, DCHPRI1_SPEC, DPA_A, O>;
...
pub type ECP_W<'a, const O: u8> = crate::BitWriter<'a, u8, DCHPRI1_SPEC, ECP_A, O>;
