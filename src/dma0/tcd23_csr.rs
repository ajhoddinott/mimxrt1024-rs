#[doc = "Register `TCD23_CSR` reader"]
pub struct R(crate::R<TCD23_CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD23_CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD23_CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD23_CSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD23_CSR` writer"]
pub struct W(crate::W<TCD23_CSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD23_CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD23_CSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD23_CSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, START_A, O>;
...
pub type INTMAJOR_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, INTMAJOR_A, O>;
...
pub type INTHALF_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, INTHALF_A, O>;
...
pub type DREQ_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, DREQ_A, O>;
...
pub type ESG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, ESG_A, O>;
...
pub type MAJORELINK_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, MAJORELINK_A, O>;
...
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TCD23_CSR_SPEC, bool, O>;
...
pub type MAJORLINKCH_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD23_CSR_SPEC, u8, u8, 5, O>;
...
pub type BWC_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TCD23_CSR_SPEC, u8, BWC_A, 2, O>;
...
#[doc = "TCD Control and Status\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd23_csr](index.html) module"]
pub struct TCD23_CSR_SPEC;
impl crate::RegisterSpec for TCD23_CSR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd23_csr::R](R) reader structure"]
impl crate::Readable for TCD23_CSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd23_csr::W](W) writer structure"]
impl crate::Writable for TCD23_CSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TCD23_CSR to value 0"]
impl crate::Resettable for TCD23_CSR_SPEC {
