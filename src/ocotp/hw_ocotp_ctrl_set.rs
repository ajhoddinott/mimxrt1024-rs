#[doc = "Register `HW_OCOTP_CTRL_SET` reader"]
pub struct R(crate::R<HW_OCOTP_CTRL_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HW_OCOTP_CTRL_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HW_OCOTP_CTRL_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HW_OCOTP_CTRL_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HW_OCOTP_CTRL_SET` writer"]
pub struct W(crate::W<HW_OCOTP_CTRL_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HW_OCOTP_CTRL_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HW_OCOTP_CTRL_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HW_OCOTP_CTRL_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HW_OCOTP_CTRL_SET_SPEC, u8, u8, 6, O>;
...
pub type ERROR_W<'a, const O: u8> = crate::BitWriter1S<'a, u32, HW_OCOTP_CTRL_SET_SPEC, bool, O>;
...
pub type RELOAD_SHADOWS_W<'a, const O: u8> =
    crate::BitWriter1S<'a, u32, HW_OCOTP_CTRL_SET_SPEC, bool, O>;
...
pub type WR_UNLOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HW_OCOTP_CTRL_SET_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "OTP Controller Control and Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hw_ocotp_ctrl_set](index.html) module"]
pub struct HW_OCOTP_CTRL_SET_SPEC;
impl crate::RegisterSpec for HW_OCOTP_CTRL_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hw_ocotp_ctrl_set::R](R) reader structure"]
impl crate::Readable for HW_OCOTP_CTRL_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hw_ocotp_ctrl_set::W](W) writer structure"]
impl crate::Writable for HW_OCOTP_CTRL_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0xffff_063f;
}
#[doc = "`reset()` method sets HW_OCOTP_CTRL_SET to value 0"]
impl crate::Resettable for HW_OCOTP_CTRL_SET_SPEC {
