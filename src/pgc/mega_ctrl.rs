#[doc = "Register `MEGA_CTRL` reader"]
pub struct R(crate::R<MEGA_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MEGA_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MEGA_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MEGA_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MEGA_CTRL` writer"]
pub struct W(crate::W<MEGA_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MEGA_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MEGA_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MEGA_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, MEGA_CTRL_SPEC, PCR_A, O>;
...
#[doc = "PGC Mega Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mega_ctrl](index.html) module"]
pub struct MEGA_CTRL_SPEC;
impl crate::RegisterSpec for MEGA_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mega_ctrl::R](R) reader structure"]
impl crate::Readable for MEGA_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mega_ctrl::W](W) writer structure"]
impl crate::Writable for MEGA_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MEGA_CTRL to value 0"]
impl crate::Resettable for MEGA_CTRL_SPEC {
