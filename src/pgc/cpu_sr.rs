#[doc = "Register `CPU_SR` reader"]
pub struct R(crate::R<CPU_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPU_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPU_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPU_SR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPU_SR` writer"]
pub struct W(crate::W<CPU_SR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPU_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPU_SR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPU_SR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PSR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPU_SR_SPEC, PSR_A, O>;
...
#[doc = "PGC CPU Power Gating Controller Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpu_sr](index.html) module"]
pub struct CPU_SR_SPEC;
impl crate::RegisterSpec for CPU_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpu_sr::R](R) reader structure"]
impl crate::Readable for CPU_SR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpu_sr::W](W) writer structure"]
impl crate::Writable for CPU_SR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CPU_SR to value 0"]
impl crate::Resettable for CPU_SR_SPEC {
